...
export function mergeHalfSimulations(firstHalf, secondHalf, homeTeam, awayTeam) {
...
export function createSimulationEnvelope(match, result) {
  return {
    homeTeam: match.home,
    awayTeam: match.away,
    ...result,
